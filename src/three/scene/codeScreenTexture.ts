...
/**
 * Draws fake syntax-highlighted "code" as colored line segments on a canvas
 * and returns it as a repeatable texture. No network fetch, no image file —
 * regenerated at runtime every time the page loads.
 */
